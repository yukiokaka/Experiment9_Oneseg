...
//  \___\/\___\ 
//
//Command: xaw2verilog -intstyle /home/oneseg13/temp/HelloWorld/ipcore_dir/pll2.xaw -st pll2.v
//Design Name: pll2
...
module pll2(CLKIN1_IN, 
   ...
   defparam PLL_ADV_INST.CLKIN1_PERIOD = 12.500;
   defparam PLL_ADV_INST.CLKIN2_PERIOD = 10.000;
   defparam PLL_ADV_INST.CLKOUT0_DIVIDE = 2;
   defparam PLL_ADV_INST.CLKOUT1_DIVIDE = 2;
   defparam PLL_ADV_INST.CLKOUT2_DIVIDE = 2;
   defparam PLL_ADV_INST.CLKOUT0_PHASE = 0.000;
   defparam PLL_ADV_INST.CLKOUT1_PHASE = 180.000;
   ...
   defparam PLL_ADV_INST.CLKFBOUT_MULT = 6;
