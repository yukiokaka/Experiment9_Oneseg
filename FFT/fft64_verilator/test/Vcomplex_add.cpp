...
#include "Vcomplex_add.h"      // For This
...
VL_CTOR_IMP(Vcomplex_add) {
    Vcomplex_add__Syms* __restrict vlSymsp = __VlSymsp = new Vcomplex_add__Syms(this, name());
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    VL_CELL (__PVT__v__DOT__myFFT_module__DOT__radix4_batterfly_module1, Vcomplex_add_radix4_batterfly);
    VL_CELL (__PVT__v__DOT__myFFT_module__DOT__radix4_batterfly_module2, Vcomplex_add_radix4_batterfly);
    VL_CELL (__PVT__v__DOT__myFFT_module__DOT__radix4_batterfly_module3, Vcomplex_add_radix4_batterfly);
...
void Vcomplex_add::__Vconfigure(Vcomplex_add__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vcomplex_add::~Vcomplex_add() {
...
void Vcomplex_add::eval() {
    Vcomplex_add__Syms* __restrict vlSymsp = this->__VlSymsp; // Setup global symbol table
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Initialize
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) _eval_initial_loop(vlSymsp);
    // Evaluate till stable
    VL_DEBUG_IF(VL_PRINTF("\n----TOP Evaluate Vcomplex_add::eval\n"); );
    int __VclockLoop = 0;
    IData __Vchange=1;
...
void Vcomplex_add::_eval_initial_loop(Vcomplex_add__Syms* __restrict vlSymsp) {
...
void Vcomplex_add::_sequent__TOP__1(Vcomplex_add__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::_sequent__TOP__1\n"); );
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
...
void Vcomplex_add::_eval(Vcomplex_add__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::_eval\n"); );
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vcomplex_add::_eval_initial(Vcomplex_add__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::_eval_initial\n"); );
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vcomplex_add::final() {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::final\n"); );
    // Variables
    Vcomplex_add__Syms* __restrict vlSymsp = this->__VlSymsp;
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vcomplex_add::_eval_settle(Vcomplex_add__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::_eval_settle\n"); );
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
IData Vcomplex_add::_change_request(Vcomplex_add__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vcomplex_add::_change_request\n"); );
    Vcomplex_add* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
